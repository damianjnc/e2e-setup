...
const onPasswordKeyDown = (setPassword) => (login) => (event) => {
  if (event.key === 'Enter') {
    return [setPassword(event.target.value), login()]
  }
    ...
    <div className={classes.mainParent}>
      <form className={classes.container} noValidate autoComplete="off">
        ...
        <TextField
          ...
          type="password"
          value={password}
          onKeyPress={onPasswordKeyDown(setPassword)(() =>
  ...
  return (
    <div className={classes.mainParent}>
      <form className={classes.container} noValidate autoComplete="off">
        ...
        <h3 className={classes.loginFailureText}>
...
const LoginView = (props) => {
  ...
  return props.login.matchWith({
    ...
    LoggingIn: () => console.log('2. loggingInView') || loggingInView(),
    LoginSuccess: () =>
      console.log('3. loginSuccessView') || loginSuccessView(),
    LoginError: ({ error }) =>
